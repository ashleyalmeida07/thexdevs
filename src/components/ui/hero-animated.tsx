...
export const GRADIENT_COLORS = {
  ...
  purple: [
    { color: "#8646F4", start: "0%" },
    { color: "#6E25ED", start: "22.92%" },
    { color: "#191625", start: "42.71%" },
    { color: "#030014", start: "88.54%" },
  ],
  green: [
...
export function HeroAnimated({ children, className, layout, ...props }: HeroProps) {
  return (
...
function Word({
  ...
  const defaultTransition = { ease: [0.25, 0.1, 0.25, 1] as const, duration: 0.5 }
